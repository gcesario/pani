...
?>
<tr valign="top" class="item_cells sectiontableentry<?php echo $i ?>">
	...
	<td class="vm-cart-item-quantity"><?php
		   ...
		   <input type="text"
                ...
                <button type="submit" class="btn vmicon vm2-add_quantity_cart" name="updatecart.<?php echo $pkey ?>" title="<?php echo  vmText::_ ('COM_VIRTUEMART_CART_UPDATE') ?>"> <i class="fa fa-refresh"></i> </button>

				<button type="submit" class="btn vmicon vm2-remove_from_cart" name="delete.<?php echo $pkey ?>" title="<?php echo vmText::_ ('COM_VIRTUEMART_CART_DELETE') ?>" > <i class="fa fa-times"></i></button>
       </div>
	</td>
	<?php if (VmConfig::get ('show_tax')) { ?>
