		...
		if(($title || $sub_title) && $title_subtitle_position){
			$output .= '<div class="overlay-image-title">';
				$output .= '<'.$heading_selector.' class="sppb-addon-title">';
					...
					if($title_icon){
						$output .= '<i class="fa ' . $title_icon . '" aria-hidden="true"></i>';
					}
					$output .= $title;
					if($title_link){
						$output .= '</a>';
				...
				if($sub_title){
					$output .= '<'.$subtitle_heading_selector.' class="sppb-addon-subtitle">';
						if($sub_title_icon){
							$output .= '<i class="fa ' . $sub_title_icon . '" aria-hidden="true"></i>';
						}
						$output .= $sub_title;
	...
	public static function getTemplate() {
		...
		<#
			...
			if(data.image.indexOf("http://") == 0 || data.image.indexOf("https://") == 0){
				...
				image_link = pagebuilder_base + data.image;
			}
			...
			<div class="overlay-image-title">
				...
				<{{data.subtitle_heading_selector}} class="sppb-addon-subtitle">
					<# if(data.sub_title_icon){ #>
						<i class="fa {{data.sub_title_icon}}"></i>
					<# } #>
